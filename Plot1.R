...
hist(P, xlab = "Global Active Power (kilowatts)", main = paste("Global Active Power"), col = "red")

#6. save hitogram in a png file
dev.copy(png, file = "Plot1.png") #save to a png file
